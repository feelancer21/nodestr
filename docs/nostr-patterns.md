...
- [Nostr Security Model](#nostr-security-model)
- [Event Design](#event-design)
- [Querying & Data Fetching](#querying--data-fetching)
- [Event Validation](#event-validation)
- [Hooks & Components](#hooks--components)
- [NIP-19 Identifiers](#nip-19-identifiers)
...
| Range | Name | Behavior |
|-------|------|----------|
| 1000-9999 | Regular Events | Stored by relays permanently. Used for persistent content like notes, articles, etc. |
| 10000-19999 | Replaceable Events | Only the latest event per pubkey+kind combination is stored. Used for profile metadata, contact lists, etc. |
| 30000-39999 | Addressable Events | Identified by pubkey+kind+d-tag combination, only latest per combination is stored. Used for articles, long-form content, etc. |
...
### Community-Specific Content (`t` tag)
...
- NOT for generic platforms: Twitter clones, general Nostr clients
...
### Query Nostr Data with TanStack Query
...
### NoteContent (Rich Text Rendering)
